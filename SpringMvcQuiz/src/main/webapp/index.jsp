...
<button onclick="location.href='shop/ipgo'" class="btn btn-outline-danger">post방식 테이블 출력(상품명,가격,색상,카테고리)_result3</button><br>
<button onclick="location.href='myshinsang'" class="btn btn-outline-warning">post방식 Map 출력(이름,나이,혈액형,주소)_result4</button><br>
</body>
</html>